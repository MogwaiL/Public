---
title: "A Tale of Two Cities - LFC vs MCFC"
output:
  html_document:
    df_print: paged
---
...
Football.Revenues
## We call the new object 'Football.Revenues to obtain a visualization.
```
...
Revenue.Piehtml <- htmltools::div(Revenue.Pie, align="center",
                style = "display:inline-block")

htmltools::save_html(Revenue.Piehtml, "Revenue.Pie.html" )
```
...
Revenue.Plothtml <- htmltools::div(Revenue.Plot, align="center",
                style = "display:inline-block")

htmltools::save_html(Revenue.Plot, "Revenue.Plot.html" )
```
...
Stream.Plothtml <- htmltools::div(Stream.Plot, align="center",
                style = "display:inline-block")

htmltools::save_html(Stream.Plot, "Stream.Plot.html" )
```
...
Transactionshtml <- htmltools::div(TransactionScatter, align="center",
                style = "display:inline-block")

htmltools::save_html(Transactionshtml, "Transactions.html" )
```
...
LFCNationTrendPlot <- 
  plot_ly(
    ...
    data = LFCNationTrendSummary,
          ...
          type = "scatter",
          mode = 'lines+markers',
    lines = list("England", "Brazil", "France", "Argentina", "Netherlands", "Spain"),
